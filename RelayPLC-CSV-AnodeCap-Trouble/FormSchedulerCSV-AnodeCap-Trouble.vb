...
Public Class FormSchedulerCSV_AnodeCap_Trouble
#Region "INITIAL"
...
#Region "DECLARATION"
    ...
    Dim AnodeCap1 As Byte = 1
    Dim AnodeCap2 As Byte = 2
    Dim AnodeCap3 As Byte = 3
    Dim AnodeCap4 As Byte = 4
    Dim AnodeCap5 As Byte = 5
    Dim AnodeCap6 As Byte = 6
    Dim AnodeCap7 As Byte = 7
    Dim AnodeCap8 As Byte = 8
    Dim AnodeCap9 As Byte = 9
    Dim AnodeCap10 As Byte = 10
    Dim AnodeCap11 As Byte = 11
    Dim AnodeCap12 As Byte = 12
    Dim AnodeCap13 As Byte = 13
    Dim AnodeCap14 As Byte = 14
    Dim AnodeCap15 As Byte = 15
...
#Region "EVENTS"
    ...
    Private Sub FormSchedulerCSV_AnodeCap_Trouble_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtMsg.Text = ""
    ...
    Private Sub FormSchedulerCSV_AnodeCap_Trouble_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
        If Me.WindowState = FormWindowState.Minimized Then
            If Me.WindowState = FormWindowState.Minimized Then
                NotifyIcon1.Visible = True
                'NotifyIcon1.Icon = SystemIcons.Application
                NotifyIcon1.BalloonTipIcon = ToolTipIcon.Info
                NotifyIcon1.BalloonTipTitle = "RELAY PLC CSV TROUBLE (AnodeCap)"
...
#Region "PROCEDURES"
    ...
    Private Sub up_Process()
        ...
        Try
            ...
            '01. Sealant coating A-4
            pProses = "Sealant coating A-4"
            up_ProcessData(AnodeCap1, "Sealant coating A-4", gs_LocalPathMix01, gs_FileName_TroubleMix01, "019", 2)

            '02. Coupling A-4
            pProses = "Coupling A-4"
            up_ProcessData(AnodeCap2, "Coupling A-4", gs_LocalPathMix02, gs_FileName_TroubleMix02, "020", 2)

            '03. Leveling A-4
            pProses = "Leveling A-4"
            up_ProcessData(AnodeCap3, "Leveling A-4", gs_LocalPathMix03, gs_FileName_TroubleMix03, "021", 2)

            '04. Sealant coating A-5
            pProses = "Sealant coating A-5"
            up_ProcessData(AnodeCap4, "Sealant coating A-5", gs_LocalPathMix04, gs_FileName_TroubleMix04, "022", 3)

            '05. Coupling A-5
            pProses = "Coupling A-5"
            up_ProcessData(AnodeCap5, "Coupling A-5", gs_LocalPathMix05, gs_FileName_TroubleMix05, "023", 3)

            '06. Leveling A-5
            pProses = "Leveling A-5"
            up_ProcessData(AnodeCap6, "Leveling A-5", gs_LocalPathMix06, gs_FileName_TroubleMix06, "024", 3)

            '07. Sealant coating A-6
            pProses = "Sealant coating A-6"
            up_ProcessData(AnodeCap7, "Sealant coating A-6", gs_LocalPathMix07, gs_FileName_TroubleMix07, "025", 3)

            '08. Coupling A-6
            pProses = "Coupling A-6"
            up_ProcessData(AnodeCap8, "Coupling A-6", gs_LocalPathMix08, gs_FileName_TroubleMix08, "026", 3)

            '09. Leveling A-6
            pProses = "Leveling A-6"
            up_ProcessData(AnodeCap9, "Leveling A-6", gs_LocalPathMix09, gs_FileName_TroubleMix09, "027", 3)

            '10. Sealant coating A-7
            pProses = "Sealant coating A-7"
            up_ProcessData(AnodeCap10, "Sealant coating A-7", gs_LocalPathMix10, gs_FileName_TroubleMix10, "028", 3)

            '11. Coupling A-7
            pProses = "Coupling A-7"
            up_ProcessData(AnodeCap11, "Coupling A-7", gs_LocalPathMix11, gs_FileName_TroubleMix11, "029", 3)

            '12. Leveling A-7
            pProses = "Leveling A-7"
            up_ProcessData(AnodeCap12, "Leveling A-7", gs_LocalPathMix12, gs_FileName_TroubleMix12, "030", 3)

            '13. Sealant coating A-9
            pProses = "Sealant coating A-9"
            up_ProcessData(AnodeCap13, "Sealant coating A-9", gs_LocalPathMix13, gs_FileName_TroubleMix13, "031", 3)

            '14. Coupling A-9
            pProses = "Coupling A-9"
            up_ProcessData(AnodeCap14, "Coupling A-9", gs_LocalPathMix14, gs_FileName_TroubleMix14, "032", 3)

            '15. Leveling A-9
            pProses = "Leveling A-9"
            up_ProcessData(AnodeCap15, "Leveling A-9", gs_LocalPathMix15, gs_FileName_TroubleMix15, "033", 3)
            ...
            Using connection As New SqlConnection(ConStr)
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Sealant coating A-4" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Coupling A-4" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Leveling A-4" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Sealant coating A-5" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Coupling A-5" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Leveling A-5" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Sealant coating A-6" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Coupling A-6" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Leveling A-6" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Sealant coating A-7" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Coupling A-7" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Leveling A-7" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Sealant coating A-9" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Coupling A-9" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Leveling A-9" Then
...
#Region "PROCESS"
    ...
    Private Sub up_TimeStart()
        ...
        Try
            ...
            With Thd_Mix01
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap01)
            ...
            With Thd_Mix02
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap02)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix03
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap03)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix04
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap04)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix05
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap05)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix06
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap06)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix07
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap07)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix08
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap08)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix09
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap09)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix10
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap10)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix11
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap11)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix12
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap12)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix13
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap13)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix14
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap14)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix15
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshAnodeCap15)
                .ScheduleThd.IsBackground = True
    ...
    Private Sub up_RefreshAnodeCap01()
        up_Refresh(AnodeCap1, "Sealant coating A-4", Thd_Mix01, gs_ServerPathMix01, gs_LocalPathMix01, gs_UserMix01, gs_PasswordMix01, gs_FileName_TroubleMix01, 2, "019", "12021")
    End Sub
    Private Sub up_RefreshAnodeCap02()
        up_Refresh(AnodeCap2, "Coupling A-4", Thd_Mix02, gs_ServerPathMix02, gs_LocalPathMix02, gs_UserMix02, gs_PasswordMix02, gs_FileName_TroubleMix02, 2, "020", "12022")
    End Sub
    Private Sub up_RefreshAnodeCap03()
        up_Refresh(AnodeCap3, "Leveling A-4", Thd_Mix03, gs_ServerPathMix03, gs_LocalPathMix03, gs_UserMix03, gs_PasswordMix03, gs_FileName_TroubleMix03, 2, "021", "12023")
    End Sub
    Private Sub up_RefreshAnodeCap04()
        up_Refresh(AnodeCap4, "Sealant coating A-5", Thd_Mix04, gs_ServerPathMix04, gs_LocalPathMix04, gs_UserMix04, gs_PasswordMix04, gs_FileName_TroubleMix04, 2, "022", "12024")
    End Sub
    Private Sub up_RefreshAnodeCap05()
        up_Refresh(AnodeCap5, "Coupling A-5", Thd_Mix05, gs_ServerPathMix05, gs_LocalPathMix05, gs_UserMix05, gs_PasswordMix05, gs_FileName_TroubleMix05, 2, "023", "12025")
    End Sub

    Private Sub up_RefreshAnodeCap06()
        up_Refresh(AnodeCap6, "Leveling A-5", Thd_Mix06, gs_ServerPathMix06, gs_LocalPathMix06, gs_UserMix06, gs_PasswordMix06, gs_FileName_TroubleMix06, 2, "024", "12026")
    End Sub

    Private Sub up_RefreshAnodeCap07()
        up_Refresh(AnodeCap7, "Sealant coating A-6", Thd_Mix07, gs_ServerPathMix07, gs_LocalPathMix07, gs_UserMix07, gs_PasswordMix07, gs_FileName_TroubleMix07, 2, "025", "12027")
    End Sub

    Private Sub up_RefreshAnodeCap08()
        up_Refresh(AnodeCap8, "Coupling A-6", Thd_Mix08, gs_ServerPathMix08, gs_LocalPathMix08, gs_UserMix08, gs_PasswordMix08, gs_FileName_TroubleMix08, 2, "026", "12028")
    End Sub

    Private Sub up_RefreshAnodeCap09()
        up_Refresh(AnodeCap9, "Leveling A-6", Thd_Mix09, gs_ServerPathMix09, gs_LocalPathMix09, gs_UserMix09, gs_PasswordMix09, gs_FileName_TroubleMix09, 2, "027", "12029")
    End Sub

    Private Sub up_RefreshAnodeCap10()
        up_Refresh(AnodeCap10, "Sealant coating A-7", Thd_Mix10, gs_ServerPathMix10, gs_LocalPathMix10, gs_UserMix10, gs_PasswordMix10, gs_FileName_TroubleMix10, 2, "028", "12030")
    End Sub

    Private Sub up_RefreshAnodeCap11()
        up_Refresh(AnodeCap11, "Coupling A-7", Thd_Mix11, gs_ServerPathMix11, gs_LocalPathMix11, gs_UserMix11, gs_PasswordMix11, gs_FileName_TroubleMix11, 2, "029", "12031")
    End Sub

    Private Sub up_RefreshAnodeCap12()
        up_Refresh(AnodeCap12, "Leveling A-7", Thd_Mix12, gs_ServerPathMix12, gs_LocalPathMix12, gs_UserMix12, gs_PasswordMix12, gs_FileName_TroubleMix12, 2, "030", "12032")
    End Sub

    Private Sub up_RefreshAnodeCap13()
        up_Refresh(AnodeCap13, "Sealant coating A-9", Thd_Mix13, gs_ServerPathMix13, gs_LocalPathMix13, gs_UserMix13, gs_PasswordMix13, gs_FileName_TroubleMix13, 2, "031", "12033")
    End Sub

    Private Sub up_RefreshAnodeCap14()
        up_Refresh(AnodeCap14, "Coupling A-9", Thd_Mix14, gs_ServerPathMix14, gs_LocalPathMix14, gs_UserMix14, gs_PasswordMix14, gs_FileName_TroubleMix14, 2, "032", "12034")
    End Sub

    Private Sub up_RefreshAnodeCap15()
        up_Refresh(AnodeCap15, "Leveling A-9", Thd_Mix15, gs_ServerPathMix15, gs_LocalPathMix15, gs_UserMix15, gs_PasswordMix15, gs_FileName_TroubleMix15, 2, "033", "12035")
    End Sub
