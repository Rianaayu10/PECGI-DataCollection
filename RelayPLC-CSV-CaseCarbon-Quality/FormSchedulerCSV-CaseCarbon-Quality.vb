...
Public Class FormSchedulerCSV_CaseCarbon_Quality
#Region "INITIAL"
...
#Region "EVENTS"
    ...
    Private Sub FormSchedulerCSV_CaseCarbon_Quality_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtMsg.Text = ""
    ...
    Private Sub FormSchedulerCSV_CaseCarbon_Quality_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
...
#Region "PROCEDURES"
    ...
    Private Sub up_Process()
        ...
        Try
            ...
            '01. CaseCarbon X-01
            pProses = "CaseCarbon X-01"
            up_ProcessData(CaseCarbon1, "CaseCarbon X-01", gs_LocalPathMix01, gs_FileName_QualityMix01, 1, "", "")

            '02. CaseCarbon X-02
            pProses = "CaseCarbon X-02"
            up_ProcessData(CaseCarbon2, "CaseCarbon X-02", gs_LocalPathMix02, gs_FileName_QualityMix02, 1, "", "")

            '03. CaseCarbon X-03
            pProses = "CaseCarbon X-03"
            up_ProcessData(CaseCarbon3, "CaseCarbon X-03", gs_LocalPathMix03, gs_FileName_QualityMix03, 1, "", "")

            '04. CaseCarbon X-04
            pProses = "CaseCarbon X-04"
            up_ProcessData(CaseCarbon4, "CaseCarbon X-04", gs_LocalPathMix04, gs_FileName_QualityMix04, 1, "", "")

            '05. CaseCarbon X-05
            pProses = "CaseCarbon X-05"
            up_ProcessData(CaseCarbon5, "CaseCarbon X-05", gs_LocalPathMix05, gs_FileName_QualityMix05, 1, "", "")
            ...
            Using connection As New SqlConnection(ConStr)
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseCarbon X-01" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseCarbon X-02" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseCarbon X-03" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseCarbon X-04" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseCarbon X-05" Then
...
#Region "PROCESS"
    ...
    Private Sub up_RefreshCaseCarbon01()
        up_Refresh(CaseCarbon1, "CaseCarbon X-01", Thd_Mix01, gs_ServerPathMix01, gs_LocalPathMix01, gs_UserMix01, gs_PasswordMix01, gs_FileName_QualityMix01, 1, "", "")
    End Sub
    Private Sub up_RefreshCaseCarbon02()
        up_Refresh(CaseCarbon2, "CaseCarbon X-02", Thd_Mix02, gs_ServerPathMix02, gs_LocalPathMix02, gs_UserMix02, gs_PasswordMix02, gs_FileName_QualityMix02, 1, "", "")
    End Sub
    Private Sub up_RefreshCaseCarbon03()
        up_Refresh(CaseCarbon3, "CaseCarbon X-03", Thd_Mix03, gs_ServerPathMix03, gs_LocalPathMix03, gs_UserMix03, gs_PasswordMix03, gs_FileName_QualityMix03, 1, "", "")
    End Sub
    Private Sub up_RefreshCaseCarbon04()
        up_Refresh(CaseCarbon4, "CaseCarbon X-04", Thd_Mix04, gs_ServerPathMix04, gs_LocalPathMix04, gs_UserMix04, gs_PasswordMix04, gs_FileName_QualityMix04, 1, "", "")
    End Sub
    Private Sub up_RefreshCaseCarbon05()
        up_Refresh(CaseCarbon5, "CaseCarbon X-05", Thd_Mix05, gs_ServerPathMix05, gs_LocalPathMix05, gs_UserMix05, gs_PasswordMix05, gs_FileName_QualityMix05, 1, "", "")
    End Sub
