...
Public Class FormSchedulerCSV_Mixing_Trouble
#Region "INITIAL"
...
#Region "EVENTS"
    ...
    Private Sub FormSchedulerCSV_Mixing_Trouble_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtMsg.Text = ""
    ...
    Private Sub FormSchedulerCSV_Mixing_Trouble_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
        If Me.WindowState = FormWindowState.Minimized Then
            If Me.WindowState = FormWindowState.Minimized Then
                NotifyIcon1.Visible = True
                'NotifyIcon1.Icon = SystemIcons.Application
                NotifyIcon1.BalloonTipIcon = ToolTipIcon.Info
                NotifyIcon1.BalloonTipTitle = "RELAY PLC CSV TROUBLE (MIXING)"
...
#Region "PROCEDURES"
    ...
    Private Sub up_Process()
        ...
        Try
            ...
            '01. MIXING X-01
            pProses = "MIXING X-01"
            up_ProcessData(Mixing1, "MIXING X-01", gs_LocalPathMix01, gs_FileName_TroubleMix01, "078", 1)

            '02. MIXING X-02
            pProses = "MIXING X-02"
            up_ProcessData(Mixing2, "MIXING X-02", gs_LocalPathMix02, gs_FileName_TroubleMix02, "082", 1)

            '03. MIXING X-03
            pProses = "MIXING X-03"
            up_ProcessData(Mixing3, "MIXING X-03", gs_LocalPathMix03, gs_FileName_TroubleMix03, "079", 1)

            '04. MIXING X-04
            pProses = "MIXING X-04"
            up_ProcessData(Mixing4, "MIXING X-04", gs_LocalPathMix04, gs_FileName_TroubleMix04, "080", 1)

            '05. MIXING X-05
            pProses = "MIXING X-05"
            up_ProcessData(Mixing5, "MIXING X-05", gs_LocalPathMix05, gs_FileName_TroubleMix05, "081", 1)
...
#Region "PROCESS"
    ...
    Private Sub up_RefreshMixing01()
        up_Refresh(Mixing1, "MIXING X-01", Thd_Mix01, gs_ServerPathMix01, gs_LocalPathMix01, gs_UserMix01, gs_PasswordMix01, gs_FileName_TroubleMix01, 1, "078", "11021")
    End Sub
    Private Sub up_RefreshMixing02()
        up_Refresh(Mixing2, "MIXING X-02", Thd_Mix02, gs_ServerPathMix02, gs_LocalPathMix02, gs_UserMix02, gs_PasswordMix02, gs_FileName_TroubleMix02, 1, "082", "11025")
    End Sub
    Private Sub up_RefreshMixing03()
        up_Refresh(Mixing3, "MIXING X-03", Thd_Mix03, gs_ServerPathMix03, gs_LocalPathMix03, gs_UserMix03, gs_PasswordMix03, gs_FileName_TroubleMix03, 1, "079", "11022")
    End Sub
    Private Sub up_RefreshMixing04()
        up_Refresh(Mixing4, "MIXING X-04", Thd_Mix04, gs_ServerPathMix04, gs_LocalPathMix04, gs_UserMix04, gs_PasswordMix04, gs_FileName_TroubleMix04, 1, "080", "11023")
    End Sub
    Private Sub up_RefreshMixing05()
        up_Refresh(Mixing5, "MIXING X-05", Thd_Mix05, gs_ServerPathMix05, gs_LocalPathMix05, gs_UserMix05, gs_PasswordMix05, gs_FileName_TroubleMix05, 1, "081", "11024")
    End Sub
