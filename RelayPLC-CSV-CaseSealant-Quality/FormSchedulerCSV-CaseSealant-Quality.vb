...
Public Class FormSchedulerCSV_CaseSealant_Quality
#Region "INITIAL"
...
#Region "DECLARATION"
    ...
    Dim CaseSealant3 As Byte = 3
    Dim CaseSealant4 As Byte = 4
    Dim CaseSealant5 As Byte = 5
...
#Region "EVENTS"
    ...
    Private Sub FormSchedulerCSV_CaseSealant_Quality_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtMsg.Text = ""
    ...
    Private Sub FormSchedulerCSV_CaseSealant_Quality_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
...
#Region "PROCEDURES"
    ...
    Private Sub up_Process()
        ...
        Try
            ...
            '01. CaseSealant X-01
            pProses = "CaseSealant X-01"
            up_ProcessData(CaseSealant1, "CaseSealant X-01", gs_LocalPathMix01, gs_FileName_QualityMix01, 1, "", "")

            '02. CaseSealant X-02
            pProses = "CaseSealant X-02"
            up_ProcessData(CaseSealant2, "CaseSealant X-02", gs_LocalPathMix02, gs_FileName_QualityMix02, 1, "", "")

            '03. CaseSealant X-03
            pProses = "CaseSealant X-03"
            up_ProcessData(CaseSealant3, "CaseSealant X-03", gs_LocalPathMix03, gs_FileName_QualityMix03, 1, "", "")

            '04. CaseSealant X-04
            pProses = "CaseSealant X-04"
            up_ProcessData(CaseSealant4, "CaseSealant X-04", gs_LocalPathMix04, gs_FileName_QualityMix04, 1, "", "")

            '05. CaseSealant X-05
            pProses = "CaseSealant X-05"
            up_ProcessData(CaseSealant5, "CaseSealant X-05", gs_LocalPathMix05, gs_FileName_QualityMix05, 1, "", "")
            ...
            Using connection As New SqlConnection(ConStr)
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseSealant X-01" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseSealant X-02" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseSealant X-03" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseSealant X-04" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "CaseSealant X-05" Then
...
#Region "PROCESS"
    ...
    Private Sub up_TimeStart()
        ...
        Try
            ...
            With Thd_Mix03
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshCaseSealant03)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix04
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshCaseSealant04)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix05
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshCaseSealant05)
                .ScheduleThd.IsBackground = True
    ...
    Private Sub up_RefreshCaseSealant01()
        up_Refresh(CaseSealant1, "CaseSealant X-01", Thd_Mix01, gs_ServerPathMix01, gs_LocalPathMix01, gs_UserMix01, gs_PasswordMix01, gs_FileName_QualityMix01, 1, "", "")
    End Sub
    Private Sub up_RefreshCaseSealant02()
        up_Refresh(CaseSealant2, "CaseSealant X-02", Thd_Mix02, gs_ServerPathMix02, gs_LocalPathMix02, gs_UserMix02, gs_PasswordMix02, gs_FileName_QualityMix02, 1, "", "")
    End Sub
    Private Sub up_RefreshCaseSealant03()
        up_Refresh(CaseSealant3, "CaseSealant X-03", Thd_Mix03, gs_ServerPathMix03, gs_LocalPathMix03, gs_UserMix03, gs_PasswordMix03, gs_FileName_QualityMix03, 1, "", "")
    End Sub
    Private Sub up_RefreshCaseSealant04()
        up_Refresh(CaseSealant4, "CaseSealant X-04", Thd_Mix04, gs_ServerPathMix04, gs_LocalPathMix04, gs_UserMix04, gs_PasswordMix04, gs_FileName_QualityMix04, 1, "", "")
    End Sub
    Private Sub up_RefreshCaseSealant05()
        up_Refresh(CaseSealant5, "CaseSealant X-05", Thd_Mix05, gs_ServerPathMix05, gs_LocalPathMix05, gs_UserMix05, gs_PasswordMix05, gs_FileName_QualityMix05, 1, "", "")
    End Sub
