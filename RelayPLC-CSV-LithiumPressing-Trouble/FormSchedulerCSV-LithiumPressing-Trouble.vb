...
Public Class FormSchedulerCSV_LithiumPressing_Trouble
#Region "INITIAL"
...
#Region "DECLARATION"
    ...
    Dim LithiumPressing1 As Byte = 1
    Dim LithiumPressing2 As Byte = 2
    Dim LithiumPressing3 As Byte = 3
    Dim LithiumPressing4 As Byte = 4
    Dim LithiumPressing5 As Byte = 5
    Dim LithiumPressing6 As Byte = 6
    Dim LithiumPressing7 As Byte = 7
    Dim LithiumPressing8 As Byte = 8
    Dim LithiumPressing9 As Byte = 9
    Dim LithiumPressing10 As Byte = 10
    Dim LithiumPressing11 As Byte = 11
    Dim LithiumPressing12 As Byte = 12
    Dim LithiumPressing13 As Byte = 13
    Dim LithiumPressing14 As Byte = 14
    Dim LithiumPressing15 As Byte = 15
    Dim LithiumPressing16 As Byte = 16
    Dim LithiumPressing17 As Byte = 17
    Dim LithiumPressing18 As Byte = 18
    ...
    Dim Thd_Mix15 As SchedulerSetting
    Dim Thd_Mix16 As SchedulerSetting
    Dim Thd_Mix17 As SchedulerSetting
    Dim Thd_Mix18 As SchedulerSetting
...
#Region "EVENTS"
    ...
    Private Sub btnStop_Click(sender As Object, e As EventArgs) Handles btnStop.Click
        ...
        Do Until Thd_Mix15.ScheduleThd.ThreadState = Threading.ThreadState.Stopped
            If Thd_Mix15.Status = "iddle" Then
                Thd_Mix15.ScheduleThd = Nothing
            End If
            If Thd_Mix15.ScheduleThd Is Nothing Then Exit Do
            Thread.Sleep(100)
        Loop

        Do Until Thd_Mix16.ScheduleThd.ThreadState = Threading.ThreadState.Stopped
            If Thd_Mix16.Status = "iddle" Then
                Thd_Mix16.ScheduleThd = Nothing
            End If
            If Thd_Mix16.ScheduleThd Is Nothing Then Exit Do
            Thread.Sleep(100)
        Loop

        Do Until Thd_Mix17.ScheduleThd.ThreadState = Threading.ThreadState.Stopped
            If Thd_Mix17.Status = "iddle" Then
                Thd_Mix17.ScheduleThd = Nothing
            End If
            If Thd_Mix17.ScheduleThd Is Nothing Then Exit Do
            Thread.Sleep(100)
        Loop

        Do Until Thd_Mix18.ScheduleThd.ThreadState = Threading.ThreadState.Stopped
            If Thd_Mix18.Status = "iddle" Then
                Thd_Mix18.ScheduleThd = Nothing
            End If
            If Thd_Mix18.ScheduleThd Is Nothing Then Exit Do
            Thread.Sleep(100)
        Loop
    ...
    Private Sub FormSchedulerCSV_LithiumPressing_Trouble_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtMsg.Text = ""
    ...
    Private Sub FormSchedulerCSV_LithiumPressing_Trouble_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
        If Me.WindowState = FormWindowState.Minimized Then
            If Me.WindowState = FormWindowState.Minimized Then
                NotifyIcon1.Visible = True
                'NotifyIcon1.Icon = SystemIcons.Application
                NotifyIcon1.BalloonTipIcon = ToolTipIcon.Info
                NotifyIcon1.BalloonTipTitle = "RELAY PLC CSV TROUBLE (LithiumPressing)"
...
#Region "PROCEDURES"
    ...
    Private Sub up_Process()
        ...
        Try
            ...
            up_FTP()
            ''==================
            '01. Lithium pressing LT-2
            pProses = "Lithium pressing LT-2"
            up_ProcessData(LithiumPressing1, "Lithium pressing LT-2", gs_LocalPathMix01, gs_FileName_TroubleMix01, "025", 2)

            '02. Lithium pressing LT-3
            pProses = "Lithium pressing LT-3"
            up_ProcessData(LithiumPressing2, "Lithium pressing LT-3", gs_LocalPathMix02, gs_FileName_TroubleMix02, "", 2)

            '03. Lithium pressing LT-6
            pProses = "Lithium pressing LT-6"
            up_ProcessData(LithiumPressing3, "Lithium pressing LT-6", gs_LocalPathMix03, gs_FileName_TroubleMix03, "", 2)

            '04. Lithium pressing LT-7
            pProses = "Lithium pressing LT-7"
            up_ProcessData(LithiumPressing4, "Lithium pressing LT-7", gs_LocalPathMix04, gs_FileName_TroubleMix04, "", 3)

            '05. Lithium pressing LT-8
            pProses = "Lithium pressing LT-8"
            up_ProcessData(LithiumPressing5, "Lithium pressing LT-8", gs_LocalPathMix05, gs_FileName_TroubleMix05, "", 3)

            '06. Lithium pressing LT-9
            pProses = "Lithium pressing LT-9"
            up_ProcessData(LithiumPressing6, "Lithium pressing LT-9", gs_LocalPathMix06, gs_FileName_TroubleMix06, "", 3)

            '07. Lithium pressing LT-10
            pProses = "Lithium pressing LT-10"
            up_ProcessData(LithiumPressing7, "Lithium pressing LT-10", gs_LocalPathMix07, gs_FileName_TroubleMix07, "", 3)

            '08. Lithium pressing LT-11
            pProses = "Lithium pressing LT-11"
            up_ProcessData(LithiumPressing8, "Lithium pressing LT-11", gs_LocalPathMix08, gs_FileName_TroubleMix08, "", 3)

            '09. Lithium pressing LT-12
            pProses = "Lithium pressing LT-12"
            up_ProcessData(LithiumPressing9, "Lithium pressing LT-12", gs_LocalPathMix09, gs_FileName_TroubleMix09, "", 3)

            '10. Lithium pressing LT-13
            pProses = "Lithium pressing LT-13"
            up_ProcessData(LithiumPressing10, "Lithium pressing LT-13", gs_LocalPathMix10, gs_FileName_TroubleMix10, "", 3)

            '11. Lithium pressing LT-14
            pProses = "Lithium pressing LT-14"
            up_ProcessData(LithiumPressing11, "Lithium pressing LT-14", gs_LocalPathMix11, gs_FileName_TroubleMix11, "", 3)

            '12. Lithium pressing LT-15
            pProses = "Lithium pressing LT-15"
            up_ProcessData(LithiumPressing12, "Lithium pressing LT-15", gs_LocalPathMix12, gs_FileName_TroubleMix12, "", 3)

            '13. Lithium pressing LT-17
            pProses = "Lithium pressing LT-17"
            up_ProcessData(LithiumPressing13, "Lithium pressing LT-17", gs_LocalPathMix13, gs_FileName_TroubleMix13, "", 3)

            '14. Lithium pressing LT-18
            pProses = "Lithium pressing LT-18"
            up_ProcessData(LithiumPressing14, "Lithium pressing LT-18", gs_LocalPathMix14, gs_FileName_TroubleMix14, "", 3)

            '15. Lithium pressing LT-30
            pProses = "Lithium pressing LT-30"
            up_ProcessData(LithiumPressing15, "Lithium pressing LT-30", gs_LocalPathMix15, gs_FileName_TroubleMix15, "", 3)


            '16. Lithium pressing LT-31
            pProses = "Lithium pressing LT-31"
            up_ProcessData(LithiumPressing16, "Lithium pressing LT-31", gs_LocalPathMix16, gs_FileName_TroubleMix16, "", 3)


            '17. Lithium pressing LT-32
            pProses = "Lithium pressing LT-32"
            up_ProcessData(LithiumPressing17, "Lithium pressing LT-32", gs_LocalPathMix17, gs_FileName_TroubleMix17, "", 3)

            '18. Lithium pressing LT-34
            pProses = "Lithium pressing LT-34"
            up_ProcessData(LithiumPressing18, "Lithium pressing LT-34", gs_LocalPathMix18, gs_FileName_TroubleMix18, "", 3)
            ...
            Using connection As New SqlConnection(ConStr)
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-2" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-3" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-6" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-7" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-8" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-9" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-10" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-11" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-12" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-13" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-14" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-15" Then
                            ...
                            gi_IntervalMix12 = ds.Tables(0).Rows(i)("TimeInterval")
                        End If

                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-17" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-18" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-30" Then
                            gs_ServerPathMix15 = ds.Tables(0).Rows(i)("Server_Path").ToString.Trim
                            gs_LocalPathMix15 = ds.Tables(0).Rows(i)("Local_Path").ToString.Trim
                            gs_UserMix15 = ds.Tables(0).Rows(i)("user_FTP").ToString.Trim
                            gs_PasswordMix15 = ds.Tables(0).Rows(i)("Password_FTP").ToString.Trim
                            gi_IntervalMix15 = ds.Tables(0).Rows(i)("TimeInterval")
                        End If

                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-31" Then
                            gs_ServerPathMix16 = ds.Tables(0).Rows(i)("Server_Path").ToString.Trim
                            gs_LocalPathMix16 = ds.Tables(0).Rows(i)("Local_Path").ToString.Trim
                            gs_UserMix16 = ds.Tables(0).Rows(i)("user_FTP").ToString.Trim
                            gs_PasswordMix16 = ds.Tables(0).Rows(i)("Password_FTP").ToString.Trim
                            gi_IntervalMix16 = ds.Tables(0).Rows(i)("TimeInterval")
                        End If

                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-32" Then
                            gs_ServerPathMix17 = ds.Tables(0).Rows(i)("Server_Path").ToString.Trim
                            gs_LocalPathMix17 = ds.Tables(0).Rows(i)("Local_Path").ToString.Trim
                            gs_UserMix17 = ds.Tables(0).Rows(i)("user_FTP").ToString.Trim
                            gs_PasswordMix17 = ds.Tables(0).Rows(i)("Password_FTP").ToString.Trim
                            gi_IntervalMix17 = ds.Tables(0).Rows(i)("TimeInterval")
                        End If

                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "Lithium pressing LT-34" Then
                            gs_ServerPathMix18 = ds.Tables(0).Rows(i)("Server_Path").ToString.Trim
                            gs_LocalPathMix18 = ds.Tables(0).Rows(i)("Local_Path").ToString.Trim
                            gs_UserMix18 = ds.Tables(0).Rows(i)("user_FTP").ToString.Trim
                            gs_PasswordMix18 = ds.Tables(0).Rows(i)("Password_FTP").ToString.Trim
                            gi_IntervalMix18 = ds.Tables(0).Rows(i)("TimeInterval")
                        End If
...
#Region "PROCESS"
    ...
    Private Sub up_TimeStart()
        ...
        Try
            ...
            With Thd_Mix01
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing01)
            ...
            With Thd_Mix02
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing02)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix03
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing03)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix04
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing04)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix05
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing05)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix06
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing06)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix07
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing07)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix08
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing08)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix09
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing09)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix10
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing10)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix11
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing11)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix12
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing12)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix13
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing13)
                .ScheduleThd.IsBackground = True
            ...
            With Thd_Mix14
                ...
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing14)
                .ScheduleThd.IsBackground = True
            ...
            Thread.Sleep(460)
            Thd_Mix15 = New SchedulerSetting
            With Thd_Mix15
                .Name = "Mix15"
                .EndSchedule = False
                .Lock = New Object
                .DelayTime = gi_IntervalMix15
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing15)
                .ScheduleThd.IsBackground = True
                .ScheduleThd.Name = "Mix15"
                .ScheduleThd.Start()
            End With


            Thread.Sleep(480)
            Thd_Mix16 = New SchedulerSetting
            With Thd_Mix16
                .Name = "Mix16"
                .EndSchedule = False
                .Lock = New Object
                .DelayTime = gi_IntervalMix13
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing16)
                .ScheduleThd.IsBackground = True
                .ScheduleThd.Name = "Mix16"
                .ScheduleThd.Start()
            End With

            Thread.Sleep(500)
            Thd_Mix17 = New SchedulerSetting
            With Thd_Mix17
                .Name = "Mix17"
                .EndSchedule = False
                .Lock = New Object
                .DelayTime = gi_IntervalMix17
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing17)
                .ScheduleThd.IsBackground = True
                .ScheduleThd.Name = "Mix17"
                .ScheduleThd.Start()
            End With

            Thread.Sleep(520)
            Thd_Mix18 = New SchedulerSetting
            With Thd_Mix18
                .Name = "Mix18"
                .EndSchedule = False
                .Lock = New Object
                .DelayTime = gi_IntervalMix18
                .ScheduleThd = New Thread(AddressOf up_RefreshLithiumPressing18)
                .ScheduleThd.IsBackground = True
                .ScheduleThd.Name = "Mix18"
                .ScheduleThd.Start()
            End With
    ...
    Private Sub up_TimeStop()
        ...
        SyncLock Thd_Mix15.Lock
            Thd_Mix15.EndSchedule = True
        End SyncLock

        SyncLock Thd_Mix16.Lock
            Thd_Mix16.EndSchedule = True
        End SyncLock

        SyncLock Thd_Mix17.Lock
            Thd_Mix17.EndSchedule = True
        End SyncLock

        SyncLock Thd_Mix18.Lock
            Thd_Mix18.EndSchedule = True
        End SyncLock
    End Sub
    ...
    Private Sub up_RefreshLithiumPressing01()
        up_Refresh(LithiumPressing1, "Lithium pressing LT-2", Thd_Mix01, gs_ServerPathMix01, gs_LocalPathMix01, gs_UserMix01, gs_PasswordMix01, gs_FileName_TroubleMix01, 1, "", "")
    End Sub
    Private Sub up_RefreshLithiumPressing02()
        up_Refresh(LithiumPressing2, "Lithium pressing LT-3", Thd_Mix02, gs_ServerPathMix02, gs_LocalPathMix02, gs_UserMix02, gs_PasswordMix02, gs_FileName_TroubleMix02, 1, "", "")
    End Sub
    Private Sub up_RefreshLithiumPressing03()
        up_Refresh(LithiumPressing3, "Lithium pressing LT-6", Thd_Mix03, gs_ServerPathMix03, gs_LocalPathMix03, gs_UserMix03, gs_PasswordMix03, gs_FileName_TroubleMix03, 1, "", "")
    End Sub
    Private Sub up_RefreshLithiumPressing04()
        up_Refresh(LithiumPressing4, "Lithium pressing LT-7", Thd_Mix04, gs_ServerPathMix04, gs_LocalPathMix04, gs_UserMix04, gs_PasswordMix04, gs_FileName_TroubleMix04, 1, "", "")
    End Sub
    Private Sub up_RefreshLithiumPressing05()
        up_Refresh(LithiumPressing5, "Lithium pressing LT-8", Thd_Mix05, gs_ServerPathMix05, gs_LocalPathMix05, gs_UserMix05, gs_PasswordMix05, gs_FileName_TroubleMix05, 1, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing06()
        up_Refresh(LithiumPressing6, "Lithium pressing LT-9", Thd_Mix06, gs_ServerPathMix06, gs_LocalPathMix06, gs_UserMix06, gs_PasswordMix06, gs_FileName_TroubleMix06, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing07()
        up_Refresh(LithiumPressing7, "Lithium pressing LT-10", Thd_Mix07, gs_ServerPathMix07, gs_LocalPathMix07, gs_UserMix07, gs_PasswordMix07, gs_FileName_TroubleMix07, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing08()
        up_Refresh(LithiumPressing8, "Lithium pressing LT-11", Thd_Mix08, gs_ServerPathMix08, gs_LocalPathMix08, gs_UserMix08, gs_PasswordMix08, gs_FileName_TroubleMix08, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing09()
        up_Refresh(LithiumPressing9, "Lithium pressing LT-12", Thd_Mix09, gs_ServerPathMix09, gs_LocalPathMix09, gs_UserMix09, gs_PasswordMix09, gs_FileName_TroubleMix09, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing10()
        up_Refresh(LithiumPressing10, "Lithium pressing LT-13", Thd_Mix10, gs_ServerPathMix10, gs_LocalPathMix10, gs_UserMix10, gs_PasswordMix10, gs_FileName_TroubleMix10, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing11()
        up_Refresh(LithiumPressing11, "Lithium pressing LT-14", Thd_Mix11, gs_ServerPathMix11, gs_LocalPathMix11, gs_UserMix11, gs_PasswordMix11, gs_FileName_TroubleMix11, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing12()
        up_Refresh(LithiumPressing12, "Lithium pressing LT-15", Thd_Mix12, gs_ServerPathMix12, gs_LocalPathMix12, gs_UserMix12, gs_PasswordMix12, gs_FileName_TroubleMix12, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing13()
        up_Refresh(LithiumPressing13, "Lithium pressing LT-17", Thd_Mix13, gs_ServerPathMix13, gs_LocalPathMix13, gs_UserMix13, gs_PasswordMix13, gs_FileName_TroubleMix13, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing14()
        up_Refresh(LithiumPressing14, "Lithium pressing LT-18", Thd_Mix14, gs_ServerPathMix14, gs_LocalPathMix14, gs_UserMix14, gs_PasswordMix14, gs_FileName_TroubleMix14, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing15()
        up_Refresh(LithiumPressing15, "Lithium pressing LT-30", Thd_Mix15, gs_ServerPathMix15, gs_LocalPathMix15, gs_UserMix15, gs_PasswordMix15, gs_FileName_TroubleMix15, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing16()
        up_Refresh(LithiumPressing16, "Lithium pressing LT-31", Thd_Mix16, gs_ServerPathMix16, gs_LocalPathMix16, gs_UserMix16, gs_PasswordMix16, gs_FileName_TroubleMix16, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing17()
        up_Refresh(LithiumPressing17, "Lithium pressing LT-32", Thd_Mix17, gs_ServerPathMix17, gs_LocalPathMix17, gs_UserMix17, gs_PasswordMix17, gs_FileName_TroubleMix17, 2, "", "")
    End Sub

    Private Sub up_RefreshLithiumPressing18()
        up_Refresh(LithiumPressing18, "Lithium pressing LT-34", Thd_Mix18, gs_ServerPathMix18, gs_LocalPathMix18, gs_UserMix18, gs_PasswordMix18, gs_FileName_TroubleMix18, 2, "", "")
    End Sub
    ...
    Private Sub up_FTP()
        ...
        'FTP LithiumPressing 15
        '====================
        If gs_ServerPathMix15 <> "" And gs_LocalPathMix15 <> "" Then
            FilesList = GetFtpFileList(gs_ServerPathMix15, gs_UserMix15, gs_PasswordMix15)
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserMix15, gs_PasswordMix15, gs_ServerPathMix15, gs_LocalPathMix15, gs_FileName_TroubleMix15, "zz")
            End If
        End If
        '====================


        'FTP LithiumPressing 16
        '====================
        If gs_ServerPathMix16 <> "" And gs_LocalPathMix16 <> "" Then
            FilesList = GetFtpFileList(gs_ServerPathMix16, gs_UserMix16, gs_PasswordMix16)
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserMix16, gs_PasswordMix16, gs_ServerPathMix16, gs_LocalPathMix16, gs_FileName_TroubleMix16, "zz")
            End If
        End If
        '====================

        'FTP LithiumPressing 17
        '====================
        If gs_ServerPathMix17 <> "" And gs_LocalPathMix17 <> "" Then
            FilesList = GetFtpFileList(gs_ServerPathMix17, gs_UserMix17, gs_PasswordMix17)
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserMix17, gs_PasswordMix17, gs_ServerPathMix17, gs_LocalPathMix17, gs_FileName_TroubleMix17, "zz")
            End If
        End If
        '====================

        'FTP LithiumPressing 18
        '====================
        If gs_ServerPathMix18 <> "" And gs_LocalPathMix18 <> "" Then
            FilesList = GetFtpFileList(gs_ServerPathMix18, gs_UserMix18, gs_PasswordMix18)
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserMix18, gs_PasswordMix18, gs_ServerPathMix18, gs_LocalPathMix18, gs_FileName_TroubleMix18, "zz")
            End If
        End If
        '====================
