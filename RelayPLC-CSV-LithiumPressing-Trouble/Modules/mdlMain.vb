...
#Region "Initial"
    ...
    Public gs_FileName_TroubleMix01 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix02 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix03 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix04 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix05 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix06 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix07 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix08 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix09 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix10 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix11 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix12 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix13 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix14 As String = "LOG_OperationHistory.csv"
    ...
    Public gs_FileName_TroubleMix15 As String = "LOG_OperationHistory.csv"
    Public gi_IntervalMix15 As Integer = All_Interval

    Public gs_ServerPathMix16 As String = ""
    Public gs_LocalPathMix16 As String = ""
    Public gs_UserMix16 As String = ""
    Public gs_PasswordMix16 As String = ""
    Public gs_FileName_TroubleMix16 As String = "LOG_OperationHistory.csv"
    Public gi_IntervalMix16 As Integer = All_Interval

    Public gs_ServerPathMix17 As String = ""
    Public gs_LocalPathMix17 As String = ""
    Public gs_UserMix17 As String = ""
    Public gs_PasswordMix17 As String = ""
    Public gs_FileName_TroubleMix17 As String = "LOG_OperationHistory.csv"
    Public gi_IntervalMix17 As Integer = All_Interval

    Public gs_ServerPathMix18 As String = ""
    Public gs_LocalPathMix18 As String = ""
    Public gs_UserMix18 As String = ""
    Public gs_PasswordMix18 As String = ""
    Public gs_FileName_TroubleMix18 As String = "LOG_OperationHistory.csv"
    Public gi_IntervalMix18 As Integer = All_Interval
