...
Public Class FormSchedulerCSV_LithiumPressing_Quality
#Region "INITIAL"
...
#Region "EVENTS"
    ...
    Private Sub FormSchedulerCSV_LithiumPressing_Quality_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtMsg.Text = ""
    ...
    Private Sub FormSchedulerCSV_LithiumPressing_Quality_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
...
#Region "PROCEDURES"
    ...
    Private Sub up_Process()
        ...
        Try
            ...
            '01. LithiumPressing X-01
            pProses = "LithiumPressing X-01"
            up_ProcessData(LithiumPressing1, "LithiumPressing X-01", gs_LocalPathMix01, gs_FileName_QualityMix01, 1, "025", "12060")

            '02. LithiumPressing X-02
            pProses = "LithiumPressing X-02"
            up_ProcessData(LithiumPressing2, "LithiumPressing X-02", gs_LocalPathMix02, gs_FileName_QualityMix02, 1, "", "")

            '03. LithiumPressing X-03
            pProses = "LithiumPressing X-03"
            up_ProcessData(LithiumPressing3, "LithiumPressing X-03", gs_LocalPathMix03, gs_FileName_QualityMix03, 1, "", "")

            '04. LithiumPressing X-04
            pProses = "LithiumPressing X-04"
            up_ProcessData(LithiumPressing4, "LithiumPressing X-04", gs_LocalPathMix04, gs_FileName_QualityMix04, 1, "", "")

            '05. LithiumPressing X-05
            pProses = "LithiumPressing X-05"
            up_ProcessData(LithiumPressing5, "LithiumPressing X-05", gs_LocalPathMix05, gs_FileName_QualityMix05, 1, "", "")
            ...
            Using connection As New SqlConnection(ConStr)
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "LithiumPressing X-01" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "LithiumPressing X-02" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "LithiumPressing X-03" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "LithiumPressing X-04" Then
                        ...
                        If ds.Tables(0).Rows(i)("Machine_Type").ToString.Trim = "LithiumPressing X-05" Then
...
#Region "PROCESS"
    ...
    Private Sub up_RefreshLithiumPressing01()
        up_Refresh(LithiumPressing1, "LithiumPressing X-01", Thd_Mix01, gs_ServerPathMix01, gs_LocalPathMix01, gs_UserMix01, gs_PasswordMix01, gs_FileName_QualityMix01, 1, "", "")
    End Sub
    Private Sub up_RefreshLithiumPressing02()
        up_Refresh(LithiumPressing2, "LithiumPressing X-02", Thd_Mix02, gs_ServerPathMix02, gs_LocalPathMix02, gs_UserMix02, gs_PasswordMix02, gs_FileName_QualityMix02, 1, "", "")
    End Sub
    Private Sub up_RefreshLithiumPressing03()
        up_Refresh(LithiumPressing3, "LithiumPressing X-03", Thd_Mix03, gs_ServerPathMix03, gs_LocalPathMix03, gs_UserMix03, gs_PasswordMix03, gs_FileName_QualityMix03, 1, "", "")
    End Sub
    Private Sub up_RefreshLithiumPressing04()
        up_Refresh(LithiumPressing4, "LithiumPressing X-04", Thd_Mix04, gs_ServerPathMix04, gs_LocalPathMix04, gs_UserMix04, gs_PasswordMix04, gs_FileName_QualityMix04, 1, "", "")
    End Sub
    Private Sub up_RefreshLithiumPressing05()
        up_Refresh(LithiumPressing5, "LithiumPressing X-05", Thd_Mix05, gs_ServerPathMix05, gs_LocalPathMix05, gs_UserMix05, gs_PasswordMix05, gs_FileName_QualityMix05, 1, "", "")
    End Sub
    ...
    Private Sub up_FTP()
        ...
        If gs_ServerPathMix01 <> "" And gs_LocalPathMix01 <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserMix01, gs_PasswordMix01, gs_ServerPathMix01, gs_LocalPathMix01, gs_FileName_QualityMix01, "zz")
            End If
        End If
        '====================
        ...
        If gs_ServerPathMix02 <> "" And gs_LocalPathMix02 <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserMix02, gs_PasswordMix02, gs_ServerPathMix02, gs_LocalPathMix02, gs_FileName_QualityMix02, "zz")
            End If
        End If
        '====================
        ...
        If gs_ServerPathMix03 <> "" And gs_LocalPathMix03 <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserMix03, gs_PasswordMix03, gs_ServerPathMix03, gs_LocalPathMix03, gs_FileName_QualityMix03, "zz")
            End If
        End If
        '====================
        ...
        If gs_ServerPathMix04 <> "" And gs_LocalPathMix04 <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserMix04, gs_PasswordMix04, gs_ServerPathMix04, gs_LocalPathMix04, gs_FileName_QualityMix04, "zz")
            End If
        End If
        '====================
        ...
        If gs_ServerPathMix05 <> "" And gs_LocalPathMix05 <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserMix05, gs_PasswordMix05, gs_ServerPathMix05, gs_LocalPathMix05, gs_FileName_QualityMix05, "zz")
            End If
        End If
        '====================
    End Sub
