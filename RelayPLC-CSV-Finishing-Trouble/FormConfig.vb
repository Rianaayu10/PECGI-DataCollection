...
#Region "PROCEDURE"
    ...
    Private Sub up_Combo()
        ...
        comboSource.Add("34010", "CAP CHECKER Mach")
        comboSource.Add("34011", "CELL SUPPLY BATTERY Mach")
        comboSource.Add("34012", "RING INSERT Mach")
        comboSource.Add("34013", "TUBE INSERT Mach")
        comboSource.Add("34014", "TUBE SHRINK Mach")
        comboSource.Add("34015", "SIDE CHECKER Mach")
        comboSource.Add("34016", "CELL BOXING Mach")
        comboSource.Add("34017", "SUPPLY BOX MACH Mach")
        comboSource.Add("34018", "CELL SUPPLY Mach")
        comboSource.Add("34019", "UPPER RING INSERT Mach")
        comboSource.Add("34020", "LABELLER Mach")
        comboSource.Add("34021", "OCV INSPECTION Mach")
        comboSource.Add("34022", "SIDE INSPECTION Mach")
        comboSource.Add("34023", "CELL BOXING Mach")
