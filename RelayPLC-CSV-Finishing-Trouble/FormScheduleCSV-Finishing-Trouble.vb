...
Public Class FormScheduleCSV_Finishing_Trouble
#Region "INITIAL"
...
#Region "EVENTS"
    ...
    Private Sub FormScheduleCSV_Finishing_Trouble_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtMsg.Text = ""
    ...
    Private Sub FormScheduleCSV_Finishing_Trouble_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
        If Me.WindowState = FormWindowState.Minimized Then
            If Me.WindowState = FormWindowState.Minimized Then
                NotifyIcon1.Visible = True
                'NotifyIcon1.Icon = SystemIcons.Application
                NotifyIcon1.BalloonTipIcon = ToolTipIcon.Info
                NotifyIcon1.BalloonTipTitle = "RELAY PLC CSV TROUBLE (Finishing)"
...
#Region "PROCEDURES"
    ...
    Private Sub up_Process()
        ...
        Try
            ...
            If gs_ServerPath_CAPCHECKERMac <> "" And gs_LocalPath_CAPCHECKERMac <> "" Then
                ...
                up_ProcessData(CAPCHECKERMac, "High Speed Mixer Mch", gs_LocalPath_CAPCHECKERMac, gs_FileName_History_CAPCHECKERMac, Line_CAPCHECKERMac, Group)
            End If
            '====================
            ...
            If gs_ServerPath_CELLSUPPLYBATTERYMach <> "" And gs_LocalPath_CELLSUPPLYBATTERYMach <> "" Then
                ...
                up_ProcessData(CELLSUPPLYBATTERYMach, "High Speed Mixer Mch", gs_LocalPath_CELLSUPPLYBATTERYMach, gs_FileName_History_CELLSUPPLYBATTERYMach, Line_CELLSUPPLYBATTERYMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_RINGINSERTMach <> "" And gs_LocalPath_RINGINSERTMach <> "" Then
                ...
                up_ProcessData(RINGINSERTMach, "High Speed Mixer Mch", gs_LocalPath_RINGINSERTMach, gs_FileName_History_RINGINSERTMach, Line_RINGINSERTMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_TUBEINSERTMach <> "" And gs_LocalPath_TUBEINSERTMach <> "" Then
                pProses = "High Speed Mixer Mch"
                up_ProcessData(TUBEINSERTMach, "High Speed Mixer Mch", gs_LocalPath_TUBEINSERTMach, gs_FileName_History_TUBEINSERTMach, Line_TUBEINSERTMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_TUBESHRINKMach <> "" And gs_LocalPath_TUBESHRINKMach <> "" Then
                ...
                up_ProcessData(TUBESHRINKMach, "High Speed Mixer Mch", gs_LocalPath_TUBESHRINKMach, gs_FileName_History_TUBESHRINKMach, Line_TUBESHRINKMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_SIDECHECKERMach <> "" And gs_LocalPath_SIDECHECKERMach <> "" Then
                ...
                up_ProcessData(SIDECHECKERMach, "High Speed Mixer Mch", gs_LocalPath_SIDECHECKERMach, gs_FileName_History_SIDECHECKERMach, Line_SIDECHECKERMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_CELLBOXINGMach <> "" And gs_LocalPath_CELLBOXINGMach <> "" Then
                ...
                up_ProcessData(CELLBOXINGMach, "High Speed Mixer Mch", gs_LocalPath_CELLBOXINGMach, gs_FileName_History_CELLBOXINGMach, Line_CELLBOXINGMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_SUPPLYBOXMACHMach <> "" And gs_LocalPath_SUPPLYBOXMACHMach <> "" Then
                pProses = "Box lift"
                up_ProcessData(SUPPLYBOXMACHMach, "Box lift", gs_LocalPath_SUPPLYBOXMACHMach, gs_FileName_History_SUPPLYBOXMACHMach, Line_SUPPLYBOXMACHMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_CELLSUPPLYMach <> "" And gs_LocalPath_CELLSUPPLYMach <> "" Then
                ...
                up_ProcessData(CELLSUPPLYMach, "Expandmetal tension", gs_LocalPath_CELLSUPPLYMach, gs_FileName_History_CELLSUPPLYMach, Line_CELLSUPPLYMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_UPPERRINGINSERTMach <> "" And gs_LocalPath_UPPERRINGINSERTMach <> "" Then
                ...
                up_ProcessData(UPPERRINGINSERTMach, "UPPERRINGINSERTMach", gs_LocalPath_UPPERRINGINSERTMach, gs_FileName_History_UPPERRINGINSERTMach, Line_UPPERRINGINSERTMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_LABELLERMach <> "" And gs_LocalPath_LABELLERMach <> "" Then
                ...
                up_ProcessData(LABELLERMach, "Oven Roller Mach Manual 1", gs_LocalPath_LABELLERMach, gs_FileName_History_LABELLERMach, Line_LABELLERMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_OCVINSPECTIONMach <> "" And gs_LocalPath_OCVINSPECTIONMach <> "" Then
                ...
                up_ProcessData(OCVINSPECTIONMach, "Oven Heater Mach Manual 1", gs_LocalPath_OCVINSPECTIONMach, gs_FileName_History_OCVINSPECTIONMach, Line_OCVINSPECTIONMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_SIDEINSPECTIONMach <> "" And gs_LocalPath_SIDEINSPECTIONMach <> "" Then
                ...
                up_ProcessData(SIDEINSPECTIONMach, "High Speed Mixer Mch", gs_LocalPath_SIDEINSPECTIONMach, gs_FileName_History_SIDEINSPECTIONMach, Line_SIDEINSPECTIONMach, Group)
            End If
            '====================
            ...
            If gs_ServerPath_CELLBOXINGMach2 <> "" And gs_LocalPath_CELLBOXINGMach2 <> "" Then
                ...
                up_ProcessData(CELLBOXINGMach2, "Oven Heater Mach Manual 2", gs_LocalPath_CELLBOXINGMach2, gs_FileName_History_CELLBOXINGMach2, Line_CELLBOXINGMach2, Group)
            End If
            '====================
    ...
    Private Sub up_Refresh_CAPCHECKERMac()
        up_Refresh(CAPCHECKERMac, "CAPCHECKERMac", Thd_CAPCHECKERMac, gs_ServerPath_CAPCHECKERMac, gs_LocalPath_CAPCHECKERMac, gs_User_CAPCHECKERMac, gs_Password_CAPCHECKERMac, gs_FileName_History_CAPCHECKERMac, Line_CAPCHECKERMac, Machine_CAPCHECKERMac)
    End Sub

    Private Sub up_Refresh_CELLSUPPLYBATTERYMach()
        up_Refresh(CELLSUPPLYBATTERYMach, "CELLSUPPLYBATTERYMach", Thd_CELLSUPPLYBATTERYMach, gs_ServerPath_CELLSUPPLYBATTERYMach, gs_LocalPath_CELLSUPPLYBATTERYMach, gs_User_CELLSUPPLYBATTERYMach, gs_Password_CELLSUPPLYBATTERYMach, gs_FileName_History_CELLSUPPLYBATTERYMach, Line_CELLSUPPLYBATTERYMach, Machine_CELLSUPPLYBATTERYMach)
    End Sub

    Private Sub up_Refresh_RINGINSERTMach()
        up_Refresh(RINGINSERTMach, "RINGINSERTMach", Thd_RINGINSERTMach, gs_ServerPath_RINGINSERTMach, gs_LocalPath_RINGINSERTMach, gs_User_RINGINSERTMach, gs_Password_RINGINSERTMach, gs_FileName_History_RINGINSERTMach, Line_RINGINSERTMach, Machine_RINGINSERTMach)
    End Sub

    Private Sub up_Refresh_TUBEINSERTMach()
        up_Refresh(TUBEINSERTMach, "TUBEINSERTMach", Thd_TUBEINSERTMach, gs_ServerPath_TUBEINSERTMach, gs_LocalPath_TUBEINSERTMach, gs_User_TUBEINSERTMach, gs_Password_TUBEINSERTMach, gs_FileName_History_TUBEINSERTMach, Line_TUBEINSERTMach, Machine_TUBEINSERTMach)
    End Sub

    Private Sub up_Refresh_TUBESHRINKMach()
        up_Refresh(TUBESHRINKMach, "TUBESHRINKMach", Thd_TUBESHRINKMach, gs_ServerPath_TUBESHRINKMach, gs_LocalPath_TUBESHRINKMach, gs_User_TUBESHRINKMach, gs_Password_TUBESHRINKMach, gs_FileName_History_TUBESHRINKMach, Line_TUBESHRINKMach, Machine_TUBESHRINKMach)
    End Sub

    Private Sub up_Refresh_SIDECHECKERMach()
        up_Refresh(SIDECHECKERMach, "SIDECHECKERMach", Thd_SIDECHECKERMach, gs_ServerPath_SIDECHECKERMach, gs_LocalPath_SIDECHECKERMach, gs_User_SIDECHECKERMach, gs_Password_SIDECHECKERMach, gs_FileName_History_SIDECHECKERMach, Line_SIDECHECKERMach, Machine_SIDECHECKERMach)
    End Sub

    Private Sub up_Refresh_CELLBOXINGMach()
        up_Refresh(CELLBOXINGMach, "CELLBOXINGMach", Thd_CELLBOXINGMach, gs_ServerPath_CELLBOXINGMach, gs_LocalPath_CELLBOXINGMach, gs_User_CELLBOXINGMach, gs_Password_CELLBOXINGMach, gs_FileName_History_CELLBOXINGMach, Line_CELLBOXINGMach, Machine_CELLBOXINGMach)
    End Sub

    Private Sub up_Refresh_SUPPLYBOXMACHMach()
        up_Refresh(SUPPLYBOXMACHMach, "SUPPLYBOXMACHMach", Thd_SUPPLYBOXMACHMach, gs_ServerPath_SUPPLYBOXMACHMach, gs_LocalPath_SUPPLYBOXMACHMach, gs_User_SUPPLYBOXMACHMach, gs_Password_SUPPLYBOXMACHMach, gs_FileName_History_SUPPLYBOXMACHMach, Line_SUPPLYBOXMACHMach, Machine_SUPPLYBOXMACHMach)
    End Sub

    Private Sub up_Refresh_CELLSUPPLYMach()
        up_Refresh(CELLSUPPLYMach, "CELLSUPPLYMach", Thd_CELLSUPPLYMach, gs_ServerPath_CELLSUPPLYMach, gs_LocalPath_CELLSUPPLYMach, gs_User_CELLSUPPLYMach, gs_Password_CELLSUPPLYMach, gs_FileName_History_CELLSUPPLYMach, Line_CELLSUPPLYMach, Machine_CELLSUPPLYMach)
    End Sub

    Private Sub up_Refresh_UPPERRINGINSERTMach()
        up_Refresh(UPPERRINGINSERTMach, "UPPERRINGINSERTMach", Thd_UPPERRINGINSERTMach, gs_ServerPath_UPPERRINGINSERTMach, gs_LocalPath_UPPERRINGINSERTMach, gs_User_UPPERRINGINSERTMach, gs_Password_UPPERRINGINSERTMach, gs_FileName_History_UPPERRINGINSERTMach, Line_UPPERRINGINSERTMach, Machine_UPPERRINGINSERTMach)
    End Sub

    Private Sub up_Refresh_LABELLERMach()
        up_Refresh(LABELLERMach, "LABELLERMach", Thd_LABELLERMach, gs_ServerPath_LABELLERMach, gs_LocalPath_LABELLERMach, gs_User_LABELLERMach, gs_Password_LABELLERMach, gs_FileName_History_LABELLERMach, Line_LABELLERMach, Machine_LABELLERMach)
    End Sub

    Private Sub up_Refresh_OCVINSPECTIONMach()
        up_Refresh(OCVINSPECTIONMach, "OCVINSPECTIONMach", Thd_OCVINSPECTIONMach, gs_ServerPath_OCVINSPECTIONMach, gs_LocalPath_OCVINSPECTIONMach, gs_User_OCVINSPECTIONMach, gs_Password_OCVINSPECTIONMach, gs_FileName_History_OCVINSPECTIONMach, Line_OCVINSPECTIONMach, Machine_OCVINSPECTIONMach)
    End Sub

    Private Sub up_Refresh_SIDEINSPECTIONMach()
        up_Refresh(SIDEINSPECTIONMach, "SIDEINSPECTIONMach", Thd_SIDEINSPECTIONMach, gs_ServerPath_SIDEINSPECTIONMach, gs_LocalPath_SIDEINSPECTIONMach, gs_User_SIDEINSPECTIONMach, gs_Password_SIDEINSPECTIONMach, gs_FileName_History_SIDEINSPECTIONMach, Line_SIDEINSPECTIONMach, Machine_SIDEINSPECTIONMach)
    End Sub

    Private Sub up_Refresh_CELLBOXINGMach2()
        up_Refresh(CELLBOXINGMach2, "CELLBOXINGMach2", Thd_CELLBOXINGMach2, gs_ServerPath_CELLBOXINGMach2, gs_LocalPath_CELLBOXINGMach2, gs_User_CELLBOXINGMach2, gs_Password_CELLBOXINGMach2, gs_FileName_History_CELLBOXINGMach2, Line_CELLBOXINGMach2, Machine_CELLBOXINGMach2)
    End Sub
    ...
    Private Sub up_ProcessData(ByVal pProcess As Integer, ByVal pProcessName As String, ByVal pLocalPath As String, ByVal pFileNameHistory As String, ByVal pLineCode As String, ByVal pGroupCount As Integer)
        ...
        'gs_LocalPathMIX = "D:\PECGI CSV\Finishing\LOG_Mc21001"
    ...
    Private Sub up_FTP()
        ...
        If gs_ServerPath_CAPCHECKERMac <> "" And gs_LocalPath_CAPCHECKERMac <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_CAPCHECKERMac, gs_Password_CAPCHECKERMac, gs_ServerPath_CAPCHECKERMac, gs_LocalPath_CAPCHECKERMac, gs_FileName_History_CAPCHECKERMac)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_CELLSUPPLYBATTERYMach <> "" And gs_LocalPath_CELLSUPPLYBATTERYMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_CELLSUPPLYBATTERYMach, gs_Password_CELLSUPPLYBATTERYMach, gs_ServerPath_CELLSUPPLYBATTERYMach, gs_LocalPath_CELLSUPPLYBATTERYMach, gs_FileName_History_CELLSUPPLYBATTERYMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_RINGINSERTMach <> "" And gs_LocalPath_RINGINSERTMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_RINGINSERTMach, gs_Password_RINGINSERTMach, gs_ServerPath_RINGINSERTMach, gs_LocalPath_RINGINSERTMach, gs_FileName_History_RINGINSERTMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_TUBEINSERTMach <> "" And gs_LocalPath_TUBEINSERTMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_TUBEINSERTMach, gs_Password_TUBEINSERTMach, gs_ServerPath_TUBEINSERTMach, gs_LocalPath_TUBEINSERTMach, gs_FileName_History_TUBEINSERTMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_TUBESHRINKMach <> "" And gs_LocalPath_TUBESHRINKMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_TUBESHRINKMach, gs_Password_TUBESHRINKMach, gs_ServerPath_TUBESHRINKMach, gs_LocalPath_TUBESHRINKMach, gs_FileName_History_TUBESHRINKMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_SIDECHECKERMach <> "" And gs_LocalPath_SIDECHECKERMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_SIDECHECKERMach, gs_Password_SIDECHECKERMach, gs_ServerPath_SIDECHECKERMach, gs_LocalPath_SIDECHECKERMach, gs_FileName_History_SIDECHECKERMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_CELLBOXINGMach <> "" And gs_LocalPath_CELLBOXINGMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_CELLBOXINGMach, gs_Password_CELLBOXINGMach, gs_ServerPath_CELLBOXINGMach, gs_LocalPath_CELLBOXINGMach, gs_FileName_History_CELLBOXINGMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_SUPPLYBOXMACHMach <> "" And gs_LocalPath_SUPPLYBOXMACHMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_SUPPLYBOXMACHMach, gs_Password_SUPPLYBOXMACHMach, gs_ServerPath_SUPPLYBOXMACHMach, gs_LocalPath_SUPPLYBOXMACHMach, gs_FileName_History_SUPPLYBOXMACHMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_CELLSUPPLYMach <> "" And gs_LocalPath_CELLSUPPLYMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_CELLSUPPLYMach, gs_Password_CELLSUPPLYMach, gs_ServerPath_CELLSUPPLYMach, gs_LocalPath_CELLSUPPLYMach, gs_FileName_History_CELLSUPPLYMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_UPPERRINGINSERTMach <> "" And gs_LocalPath_UPPERRINGINSERTMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_UPPERRINGINSERTMach, gs_Password_UPPERRINGINSERTMach, gs_ServerPath_UPPERRINGINSERTMach, gs_LocalPath_UPPERRINGINSERTMach, gs_FileName_History_UPPERRINGINSERTMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_LABELLERMach <> "" And gs_LocalPath_LABELLERMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_LABELLERMach, gs_Password_LABELLERMach, gs_ServerPath_LABELLERMach, gs_LocalPath_LABELLERMach, gs_FileName_History_LABELLERMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_OCVINSPECTIONMach <> "" And gs_LocalPath_OCVINSPECTIONMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_OCVINSPECTIONMach, gs_Password_OCVINSPECTIONMach, gs_ServerPath_OCVINSPECTIONMach, gs_LocalPath_OCVINSPECTIONMach, gs_FileName_History_OCVINSPECTIONMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_SIDEINSPECTIONMach <> "" And gs_LocalPath_SIDEINSPECTIONMach <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_SIDEINSPECTIONMach, gs_Password_SIDEINSPECTIONMach, gs_ServerPath_SIDEINSPECTIONMach, gs_LocalPath_SIDEINSPECTIONMach, gs_FileName_History_SIDEINSPECTIONMach)
            End If
        End If
        '====================
        ...
        If gs_ServerPath_CELLBOXINGMach2 <> "" And gs_LocalPath_CELLBOXINGMach2 <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_User_CELLBOXINGMach2, gs_Password_CELLBOXINGMach2, gs_ServerPath_CELLBOXINGMach2, gs_LocalPath_CELLBOXINGMach2, gs_FileName_History_CELLBOXINGMach2)
            End If
        End If
        '====================
    End Sub
