...
#Region "PROCEDURE"
    ...
    Private Sub up_Combo()
        With cboMachineType
            ...
            .ColumnHeaders = False
            .ClearItems()
            .AddItem("PACKING M01 - SHRINK CUTTING")
            .AddItem("PACKING M01 - WEIGHT BATCH")
            .AddItem("PACKING M01 - HEATER")
            .AddItem("PACKING M01 - TAPING 3M")
            .AddItem("PACKING M01 - WEIGHT BOX")
            .AddItem("PACKING M02 - SHRINK CUTTING")
            .AddItem("PACKING M02 - WEIGHT BATCH")
            .AddItem("PACKING M02 - HEATER")
            .AddItem("PACKING M02 - TAPING 3M")
            .AddItem("PACKING M02 - WEIGHT BOX")
            .AddItem("PILLOW PROCESS")
