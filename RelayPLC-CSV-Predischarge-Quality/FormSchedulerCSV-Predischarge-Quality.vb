...
Public Class FormSchedulerCSV_Predischarge_Quality
#Region "INITIAL"
...
#Region "EVENTS"
    ...
    Private Sub FormSchedulerCSV_Predischarge_Quality_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtMsg.Text = ""
    ...
    Private Sub FormSchedulerCSV_Predischarge_Quality_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
        If Me.WindowState = FormWindowState.Minimized Then
            If Me.WindowState = FormWindowState.Minimized Then
                NotifyIcon1.Visible = True
                'NotifyIcon1.Icon = SystemIcons.Application
                NotifyIcon1.BalloonTipIcon = ToolTipIcon.Info
                NotifyIcon1.BalloonTipTitle = "RELAY PLC CSV QUALITY (PREDISCHARGE)"
...
#Region "PROCEDURES"
    ...
    Private Sub up_Process()
        ...
        Try
            ...
            up_ProcessData(Predischarge16, "Predischarge PD-16", gs_LocalPathPD16, gs_FileName_QualityPD16, 5, "019", "21009")

            ''02. PREDISCHARGE PD-17
            'pProses = "Predischarge PD-17"
            'up_ProcessData(Predischarge17, "Predischarge PD-17", gs_LocalPathPD17, gs_FileName_QualityPD17, 5, "", "")

            ''05. PREDISCHARGE PD-18
            'pProses = "Predischarge PD-18"
            'up_ProcessData(Predischarge18, "Predischarge PD-18", gs_LocalPathPD18, gs_FileName_QualityPD18, 5, "", "")
    ...
    Private Sub up_RefreshPD16()
        up_Refresh(Predischarge16, "Predischarge PD-16", Thd_PD16, gs_ServerPathPD16, gs_LocalPathPD16, gs_UserPD16, gs_PasswordPD16, gs_FileName_QualityPD16, 5, "019", "21009")
    End Sub

    Private Sub up_RefreshPD17()
        up_Refresh(Predischarge17, "Predischarge PD-17", Thd_PD17, gs_ServerPathPD17, gs_LocalPathPD17, gs_UserPD17, gs_PasswordPD17, gs_FileName_QualityPD17, 5, "", "")
    End Sub

    Private Sub up_RefreshPD18()
        up_Refresh(Predischarge18, "Predischarge PD-18", Thd_PD18, gs_ServerPathPD18, gs_LocalPathPD18, gs_UserPD18, gs_PasswordPD18, gs_FileName_QualityPD18, 5, "", "")
    End Sub
    ...
    Private Sub up_FTP()
        ...
        If gs_ServerPathPD16 <> "" And gs_LocalPathPD16 <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserPD16, gs_PasswordPD16, gs_ServerPathPD16, gs_LocalPathPD16, gs_FileName_QualityPD16, "zz")
            End If
        End If
        '====================
        ...
        If gs_ServerPathPD17 <> "" And gs_LocalPathPD17 <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserPD17, gs_PasswordPD17, gs_ServerPathPD17, gs_LocalPathPD17, gs_FileName_QualityPD17, "zz")
            End If
        End If
        '====================
        ...
        If gs_ServerPathPD18 <> "" And gs_LocalPathPD18 <> "" Then
            ...
            If FilesList.Count > 0 Then
                DownloadFiles(FilesList, "", gs_UserPD18, gs_PasswordPD18, gs_ServerPathPD18, gs_LocalPathPD18, gs_FileName_QualityPD18, "zz")
            End If
        End If
        '====================
    End Sub
